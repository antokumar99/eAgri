...
//   // Filter products based on selected category + search text
...
//     // Navigate to ProductDetails screen (you’ll create ProductDetails.jsx)
...
//         />
//         <Icon name="search" size={20} color="green" marginRight={10} ></Icon>

//         {searchQuery.trim().length > 0 && ( // Only show when there's text
